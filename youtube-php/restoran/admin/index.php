    ...
    <div class="container">
        <div class="row mt-4">
            ...
            <div class="col-md-9">
                ...
                <div class="float-end mt-3 me-3">User : <a href="?f=user&m=updateuser&id=<?php echo $_SESSION['iduser']?>"><?php echo $_SESSION['user'] ?></a></div>
                <div class="float-end mt-3 me-3">Level : <?php echo $_SESSION['level'] ?></div>  
            </div>
        </div>
        <div class="row mt-5">
            <div class="col-md-3">
